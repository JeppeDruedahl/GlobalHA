...
@nb.njit        
def solve_hh_backwards(par,z_trans,r,w,vbeg_a_plus,vbeg_a,a,c,v_a):
    """ solve backwards with vbeg_a from previous iteration (here vbeg_a_plus) """

    solve_hh_backwards_egm(par,r,w,vbeg_a_plus,a,c,v_a)
    solve_hh_backwards_expectation(par,z_trans,v_a,vbeg_a)

@nb.njit(parallel=True)        
def solve_hh_backwards_egm(par,r,w,vbeg_a_plus,a,c,v_a):
